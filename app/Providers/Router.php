...
class Router implements ServiceProviderInterface
{
    public function register(\Fol $app)
    {
        $app['router'] = function ($app) {
            ...
            $map->get('apoderadas', '/apoderadas', "{$ns}\\Index::apoderadas");
	    $map->get('medrando', '/medrando', "{$ns}\\Index::medrando");
	    $map->get('asamblea-xaneiro', '/asamblea-xaneiro', "{$ns}\\Index::asambleaXaneiro");
            ...
            $map->get('supports', '/apoia-a-luis-villares', "{$ns}\\Index::supports");
            $map->post('supports-save', '/apoia-a-luis-villares', "{$ns}\\Index::supportsSave");
